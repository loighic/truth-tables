---
title: truth tables assignment 4
---
...
2 Which one of the following is correct about (P &or; Q) & (&not;P &rarr; Q), the sentence in the previous problem?
...
4 Which one of the following is correct about (P &LeftRightArrow; &not;Q) & (P &LeftRightArrow; Q), the sentence in the previous problem?
| This sentence is a tautology.
|* This sentence is a contradiction.
| This sentence is contingent.
~~~
...
~~~{.QualitativeProblem .MultipleChoice options="exam" points="7" late-credit="5"}
6 Which one of the following is correct about (P & Q) &rarr; (&not;P &rarr; Q), the sentence in the previous problem?
|* This sentence is a tautology.
| This sentence is a contradiction.
| This sentence is contingent.
~~~
...
~~~{.QualitativeProblem .MultipleChoice options="exam" points="7" late-credit="5"}
8 Which one of the following is correct about &not;(P &rarr; Q) and (&not;P &rarr; &not;Q), the sentences in the previous problem?
...
~~~{.QualitativeProblem .MultipleChoice options="exam" points="7" late-credit="5"}
10 Which one of the following is correct about P &rarr; Q and &not;(P & &not;Q), the sentences in the previous problem?
|* The sentences are equivalent.
| The sentences are jointly inconsistent.
| The sentences are jointly consistent (but not equivalent).
~~~
...
~~~{.QualitativeProblem .MultipleChoice options="exam" points="7" late-credit="5"}
12 Which one of the following is correct about &not;(P &LeftRightArrow; Q), ((P &rarr; Q) & (Q &rarr; P)), the sentences in the previous problem?
| The sentences are equivalent.
|* The sentences are jointly inconsistent.
| The sentences are jointly consistent (but not equivalent).
~~~
